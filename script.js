...
function generateInEmptyCell() {
  var x,y;
  do {
    x = Math.floor(Math.random() * size);  // generating random number between 0-3
...
//function to deal with moving and collapsing tiles
...
//slide left function to move number to left
function slideLeft() {
  var changed = false;
  for (var y = 0; y < size; y++) {
...
function isGameOver() {
  ...
  //if any adjacent cells are same they can be added and collapsed - game continues
...
//adding event listener to detect arrowkeys from keyboard
